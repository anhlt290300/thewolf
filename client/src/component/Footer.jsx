...
import { burgeroption } from "../assets/fakeData/headerData";
const Footer = () => {
  return (
    <footer>
      <div className=" tablet:pt-[40px] tablet:pb-[30px] py-[20px] select-none">
        <div className="px-[30px] grid desktop:grid-cols-7 tablet:grid-cols-2 grid-cols-1 desktop-L:gap-12 desktop:gap-12 tablet:gap-4">
          <div className=" tablet:mb-[20px] tablet:py-0 desktop-L:col-span-3 desktop:col-span-2 tablet:border-none border-b-[1px] border-[#efefef]">
            ...
            <div className=" tablet:mb-[20px] tablet:py-0 py-[10px] text-base leading-7 text-black-primary">
              <p>GIỚI THIỆU</p>
            </div>
            <div>
              ...
              <p className=" text-xs mb-[10px] text-black-primary leading-5 tracking-wide">
                ...
                hàng. Bằng cách tránh né cái quan điểm “thời trang nhanh gọn” và
                bắt tay tập trung vào những dây chuyền sản xuất sản phẩm một
                cách kĩ lưỡng đã giúp chúng tôi có thể tạo nên sự khác biệt.
              </p>
            </div>
          </div>

          <div className=" tablet:mb-[20px] tablet:py-0  tablet:border-none border-b-[1px] border-[#efefef]">
            <div className="tablet:mb-[20px] tablet:py-0 py-[10px] text-base leading-7">
              <p>CHÍNH SÁCH</p>
            </div>
            <ul className="mb-[15px] text-black-primary">
              {burgeroption.map((item, index) => {
                return (
                  <li key={index} className=" text-xs leading-7">
          ...
          <div className=" tablet:mb-[20px] tablet:py-0  desktop:col-span-2 tablet:border-none border-b-[1px] border-[#efefef]">
            <div className="tablet:mb-[20px] tablet:py-0 py-[10px] text-base leading-7">
              <p>LIÊN HỆ</p>
            </div>
            <ul className="mb-[15px] ">
              <li className=" relative pl-[25px] pb-[5px] leading-[22px] text-xs text-black-primary">
                <span className=" absolute top-[12px] left-0 w-[16px]">
                  <img
                    src="https://theme.hstatic.net/200000033444/1000979633/14/icon_footer_1.png?v=205"
                    alt=""
                  />
                </span>
                <p>TPHCM:</p>
                <p>▪ 79 Nguyễn Thượng Hiền, phường 5, Quận 3</p>
                <p>▪ 267 Quang Trung, phường 10, Quận Gò Vấp</p>
                <p>📞 Hotline: 0936 253 007 - 0888 543 919</p>
              </li>
              <li className=" relative pl-[25px] pb-[5px] leading-[22px] text-xs text-black-primary">
                <span className=" absolute top-[12px] left-0 w-[16px]">
                  <img
                ...
                <p>ĐÀ NẴNG:</p>
                <p>▪ 218 Lê Duẩn, P.Tân Chính, Q.Thanh Khê, Đà Nẵng</p>
                <p>▪ 267 Quang Trung, phường 10, Quận Gò Vấp</p>
                <p>📞 Hotline: 0935 837 110</p>
              </li>
              <li className=" relative pl-[25px] pb-[5px] leading-[22px] text-xs text-black-primary">
                <span className=" absolute top-[5px] left-0 w-[16px]">
                  <img
                    src="https://theme.hstatic.net/200000033444/1000979633/14/icon_footer_4.png?v=205"
                    alt=""
                  />
                </span>
                <p>thewolfvietnam@gmail.com</p>
              </li>
            </ul>
          </div>
          ...
          <div className=" tablet:mb-[20px] tablet:py-0  desktop-L:col-span-1 desktop:col-span-2 tablet:border-none border-b-[1px] border-[#efefef]">
            ...
            <ul className=" tablet:mb-[15px] mb-[30px] grid grid-cols-4 desktop-L:gap-2 desktop:gap-4 mobile-L:gap-8 gap-5 desktop:w-full w-2/3 tablet:float-left float-none mx-auto">
              ...
              <li className=" flex items-center">
                <a href="https://www.instagram.com/thewolf.vn/">
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="100%"
              ...
              <li className=" flex items-center">
                <a href="https://www.youtube.com/channel/UCmUJmEQgK5Toomk2oaJpR2Q">
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="100%"
              ...
              <li className=" flex items-center">
                <a href="https://vt.tiktok.com/ZSeLc4C8w/">
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="100%"
