      ...
      <div className=" desktop:sticky top-[55%] desktop:-translate-y-1/2 left-0 w-full">
        ...
        <div className=" ">
          <div
            ...
            className="mb-[10px] pb-[10px] group/description open border-b-[1px] border-[#e7e7e7] border-solid"
          >
            <p
            ...
            <div className=" max-h-0 overflow-hidden transition-all ease-linear duration-1000 group-[.open]/description:max-h-[500px]">
              <ul className="ml-[24px] list-disc text-[11px] mb-[10px]">
                ...
                <li>
                  <span></span>Sử dụng kỹ thuật bóp viền, một kĩ thuật đòi hỏi
                  kĩ năng của người thợ làm giày.{" "}
                </li>
                <li>
          ...
          >
            ...
            <div className=" max-h-0 overflow-hidden transition-all ease-linear duration-1000 group-[.open]/description:max-h-[500px]">
              <ul className="ml-[24px] list-disc text-[11px] mb-[10px]">
                ...
                <li>
                  <span>
                    Miễn phí 3 lần vệ sinh đánh bóng giày (mang theo thẻ vệ
                    sinh){" "}
                  </span>
                </li>
                <li>
                  ...
                  <ul className=" ml-[24px] list-circle">
                    ...
                    <li>
                      <span>
                        Trong trường hợp chưa mang lần nào, nhưng bị vấn đề về
                        đế
                      </span>
                    </li>
                  </ul>
          ...
          >
            ...
            <div className=" max-h-0 overflow-hidden transition-all ease-linear duration-1000 group-[.open]/description:max-h-[500px]">
              <ul className="ml-[24px] list-disc text-[11px] mb-[10px]">
                ...
                <li>
                  <span>
                    Mọi chi phí vận chuyển đổi size sẽ do bên mua chịu toàn bộ
                    chi phí{" "}
                  </span>
                </li>
              </ul>
              ...
              <p className="text-[11px]">
                * Liên hệ trực tiếp với chúng tôi để việc trao đổi trở nên dễ
                dàng hơn
              </p>
            </div>
          </div>
