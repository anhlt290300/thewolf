      ...
      const shoes = await newPage.$eval(
        ...
        (el) => {
          ...
          for (
            ...
            i <
            el
              .querySelector(".col-md-6.col-sm-12.col-xs-12")
              .querySelectorAll(
        ...
        `;
          ...
          let price = {
            saleprice: el
              .querySelectorAll(".col-md-3.col-sm-12.col-xs-12")[1]
              .querySelector(".product-price .pro-price")?.innerText,
            realprice: el
              .querySelectorAll(".col-md-3.col-sm-12.col-xs-12")[1]
              .querySelector(".product-price del")?.innerText,
          };
          ...
          let sizes = el
            ...
            ?.querySelector("span select").innerHTML;
